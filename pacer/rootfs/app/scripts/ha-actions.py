...
"""Fire Home Assistant events from Pacer recommendation audit rows."""
...
DEFAULT_DATABASE_URL = "postgresql://postgres@127.0.0.1:5432/pacer"
...
def get_db_connection() -> Any:
    ...
    if any(
        ...
        return psycopg2.connect(
            ...
            dbname=os.environ.get("DB_NAME", "pacer"),
        )
