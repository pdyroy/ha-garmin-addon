/**
 * ETL: InfluxDB JSON exports (Garmin data from HAOS) → PostgreSQL (Pacer app)
 *
 ...
 *
 * Usage: POSTGRES_URL="postgresql://dev:dev@localhost:5432/pacer" pnpm dlx tsx scripts/influx-to-postgres.ts
 */
...
const POSTGRES_URL =
  ...
  "postgresql://dev:dev@localhost:5432/pacer";
...
// ---------------------------------------------------------------------------
async function main() {
  console.log("🔄 Pacer ETL: InfluxDB JSON → PostgreSQL");
